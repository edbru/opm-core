...
BOOST_AUTO_TEST_CASE(resizeWellState) {
    ...
    wsResize.setBhpValue("OP_1", i1BhpSet);
    wsResize.setBhpValue(1, i2BhpSet);
    wsResize.setTemperatureValue("OP_1", i1TemperatureSet);
    wsResize.setTemperatureValue(1, i2TemperatureSet);
    wsResize.setWellRatesValue("OP_1", 1, numPhases, i1WellRatesSet);
    wsResize.setWellRatesValue(5, i2WellRatesSet);
    wsResize.setPerfRatesValue(0, i1PerfRatesSet);
    wsResize.setPerfRatesValue(1, i2PerfRatesSet);
    wsResize.setPerfRatesValue(7, i3PerfRatesSet);
    wsResize.setPerfPressValue(0, i1PerfPressSet);
    wsResize.setPerfPressValue(1, i2PerfPressSet);
    wsResize.setPerfPressValue(7, i3PerfPressSet);
    ...
    wsResize.setBhpValue(3, i3BhpSet);
    wsResize.setTemperatureValue(3, i3TemperatureSet);
    wsResize.setWellRatesValue(9, i3WellRatesSet);
    ...
    double i2WellRatesGet = wsResize.getWellRatesValue("OP_2", 3, numPhases);
